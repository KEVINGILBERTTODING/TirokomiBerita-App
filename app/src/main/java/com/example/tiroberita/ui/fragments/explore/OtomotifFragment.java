...
import com.example.tiroberita.databinding.FragmentOtomotifBinding;
...
@AndroidEntryPoint
public class OtomotifFragment extends Fragment implements ItemClickListener {

    private FragmentOtomotifBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOtomotifBinding.inflate(inflater, container, false);
    ...
    private void getData(String redactionName) {
       ...
       if (redactionName.equals(RedactionConstans.ANTARA)) {
            antaraViewModel.getDataOtomotif().observe(getViewLifecycleOwner(), new Observer<ResponseModel>() {
                ...
                public void onChanged(ResponseModel responseModel) {
                    if (responseModel.getSuccess() == true && responseModel.getDataModel() != null) {
                        ...
                        // set on click item
                        newsAdapter.setItemClickListener(OtomotifFragment.this);
            ...
            sindonewsViewModel.getDataOtomotif().observe(getViewLifecycleOwner(), new Observer<ResponseModel>() {
                @Override
                public void onChanged(ResponseModel responseModel) {
                    if (responseModel.getSuccess() == true && responseModel.getDataModel() != null) {
                        dataModel = responseModel.getDataModel();
