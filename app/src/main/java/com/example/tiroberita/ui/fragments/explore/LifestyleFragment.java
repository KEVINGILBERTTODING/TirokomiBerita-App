...
import com.example.tiroberita.databinding.FragmentLifestyleBinding;
...
@AndroidEntryPoint
public class LifestyleFragment extends Fragment implements ItemClickListener {
            ...
            cnnViewModel.getDataGayaHidup().observe(getViewLifecycleOwner(), new Observer<ResponseModel>() {
                ...
                public void onChanged(ResponseModel responseModel) {
                    if (responseModel.getSuccess() == true && responseModel.getDataModel() != null) {
                        ...
                        // set on click item
                        newsAdapter.setItemClickListener(LifestyleFragment.this);
